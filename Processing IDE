...
// converts the String variables into Integer iAngle = int(angle);
...
stroke(98,245,31);
// draws the arc lines
arc(0,0,(width-width*0.0625),(width-width*0.0625),PI,TWOP I);
arc(0, 0,(width − width ∗ 0.27),(width − width ∗ 0.27), P I, TW OP I);
arc(0, 0,(width − width ∗ 0.479),(width − width ∗ 0.479), P I, TW OP I);
arc(0, 0,(width − width ∗ 0.687),(width − width ∗ 0.687), P I, TW OP I);
//drawstheanglelines
...
voiddrawObject(){pushM atrix();
translate(width/2, height − height ∗ 0.074); //movesthestartingcoordinatstonewlocation
strokeW eight(9);
stroke(255, 10, 10); //redcolor
pixsDistance = iDistance∗((height−height∗0.1666)∗0.025); //coversthedistancefromthesensorfromcmtopixels
//limitingtherangeto40cms
if(iDistance < 40){
...
stroke(30, 250, 60);
translate(width/2, height − height ∗ 0.074); //movesthestartingcoordinatstonewlocation
line(0, 0,(height−height∗0.12)∗cos(radians(iAngle)), −(height−height∗0.12)∗sin(radians(iAngle))); //drawsthelineaccordingtotheangle
popM atrix();
}
voiddrawT ext(){//drawsthetextsonthescreen
pushM atrix();
if(iDistance > 40){
noObject = ”OutofRange”; }
else{
...
textSize(40);
text(”SmartP arkingMeter”, width − width ∗ 0.875, height − height ∗ 0.0277);
text(”Angle : ” + iAngle + ”ř”, width − width ∗ 0.48, height − height ∗ 0.0277);
text(”Distance : ”, width − width ∗ 0.26, height − height ∗ 0.0277);
if(iDistance < 40){
text(”” + iDistance + ”cm”, width − width ∗ 0.225, height − height ∗ 0.0277); }textSize(25);
f ill(98, 245, 60);
